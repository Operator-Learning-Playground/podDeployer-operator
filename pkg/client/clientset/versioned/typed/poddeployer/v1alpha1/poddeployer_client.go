...
import (
	...
	"github.com/myoperator/poddeployer/pkg/client/clientset/versioned/scheme"
...
func (c *ApiV1alpha1Client) Poddeployers(namespace string) PoddeployerInterface {
	return newPoddeployers(c, namespace)
}
